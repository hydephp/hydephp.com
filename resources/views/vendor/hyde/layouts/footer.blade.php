<footer class="px-4 pt-12 pb-8  dark:text-white dark:bg-black bg-gray-100">
    <div class="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
       <div class="block w-1/3">
		...
		<p class=" font-thin text-left text-gray-700 text-sm pl-2 pr-6 pt-2 dark:text-gray-300 ">
        ...
        <div class="block w-2/3 mt-6 text-sm sm:flex lg:mt-0">
            <ul class="flex flex-col w-full p-0 font-thin text-left text-gray-300 dark:text-gray-700 list-none">
				...
				<li><a href="{{ Hyde::relativeLink('community.html', $currentPage) }}" class="inline-block px-3 py-2 dark:text-gray-300 text-gray-700 no-underline hover:text-black dark:hover:text-white">
					Community Portal
				</a></li>
           
                <li><a href="{{ Hyde::relativeLink('legal.html', $currentPage) }}" class="inline-block px-3 py-2 dark:text-gray-300 text-gray-700 no-underline hover:text-black dark:hover:text-white">
					Legal Information
				</a></li>
            </ul>
            <ul class="flex flex-col w-full p-0 font-thin text-left text-gray-300 dark:text-gray-700 list-none">
            ...
            <ul class="flex flex-col w-full p-0 font-thin text-left text-gray-300 dark:text-gray-700 list-none">
				...
				<li><a href="{{ Hyde::relativeLink('posts.html', $currentPage) }}" class="inline-block px-3 py-2 dark:text-gray-300 text-gray-700 no-underline hover:text-black dark:hover:text-white">
					Blog Posts
				</a></li>
				
				<li><a href="{{ Hyde::relativeLink('feed.xml', $currentPage) }}" class="inline-block px-3 py-2 dark:text-gray-300 text-gray-700 no-underline hover:text-black dark:hover:text-white">
					RSS Feed
				</a></li>
            </ul>
            <div class="flex flex-col w-full text-gray-300 dark:text-gray-700">
                ...
                <div class="flex justify-start pl-4 mt-2">
					...
					<a title="GitHub Organization" class="flex items-center block mr-4 dark:text-gray-300 text-gray-700 no-underline hover:text-black dark:hover:text-white" target="_blank" rel="noopener" href="https://github.com/HydePHP">
    ...
    <div class="pt-4 pt-6 mt-10 text-center text-gray-600 border-t border-gray-300 dark:border-gray-800 "> 
		<div class="prose mx-auto text-center text-sm">
