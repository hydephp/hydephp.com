...
<nav aria-label="Main navigation" id="main-navigation" class="flex flex-wrap items-center justify-between p-4 shadow-lg sm:shadow-xl md:shadow-none dark:bg-gray-800">
	...
	<div id="main-navigation-links" class="w-full hidden md:flex flex-grow md:flex-grow-0 md:items-center md:w-auto px-6 -mx-4 border-t mt-3 pt-3 md:border-none md:mt-0 md:py-0 border-gray-200 dark:border-gray-700">
		...
		<a id="docs-nav-button" href="docs" class="relative mb-5 ml-4 sm:mb-0 group">
			<span class="absolute top-0 left-0 w-full h-full mt-1 ml-1 bg-black dark:bg-gray-600 rounded group-hover:m-0"></span>
			<span class="relative inline-block w-full h-full px-3 py-1 text-base font-bold  bg-white border-2 border-black rounded fold-bold group-hover:bg-violet-300 dark:group-hover:bg-violet-200 group-hover:text-gray-900 dark:text-black">Documentation</span>
		</a>
	</div>
</nav>
