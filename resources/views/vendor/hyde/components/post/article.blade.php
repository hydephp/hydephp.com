                ...
                <div class="flex flex-col sm:flex-row items-start gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex flex-wrap gap-3 mt-2">
                            ...
                            @if($page->matter('author.socials.x'))
                                <a href="https://x.com/{{ $page->matter('author.socials.x') }}" class="inline-flex items-center text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300" rel="nofollow external noopener" target="_blank">
                            ...
                            @if($page->matter('author.socials.github'))
                                <a href="https://github.com/{{ $page->matter('author.socials.github') }}" class="inline-flex items-center text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300" rel="nofollow external noopener" target="_blank">
                                    <svg class="h-4 w-4 mr-1" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            @if($page->matter('author.socials.linkedin'))
                                <a href="https://linkedin.com/in/{{ $page->matter('author.socials.linkedin') }}" class="inline-flex items-center text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300" rel="nofollow external noopener" target="_blank">
                                    <svg class="h-4 w-4 mr-1" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
