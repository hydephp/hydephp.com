            ...
            <div class="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-6 shadow-sm">
                ...
                <div class="mt-5 text-center">
                    <div class="text-sm text-gray-500 dark:text-gray-400">
                        <p>Want to contribute to HydePHP? We'd love to hear from you!</p>
                        <a href="https://hydephp.com/posts/guest-posts/" class="inline-flex items-center text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 font-medium mt-1">
