...
<section id="features" class="relative w-full py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-gray-50 to-white overflow-hidden">
    ...
    <!-- Wave transition -->
    <svg class="absolute bottom-0 w-full text-white fill-current transform rotate-180" viewBox="0 0 1400 74" xmlns="http://www.w3.org/2000/svg" style="margin-bottom: -1px;">
