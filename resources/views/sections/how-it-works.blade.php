...
<body class="bg-slate-900">
    ...
    <section class="min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-800 to-slate-900">
        <div class="text-center">
            <h2 class="text-4xl font-bold text-white mb-4">Ready to build?</h2>
            <p class="text-xl text-slate-300 mb-8">Get started with HydePHP today</p>
            <button class="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg font-semibold text-lg hover:shadow-xl transform hover:scale-105 transition">
                Get Started →
            </button>
        </div>
    </section>
