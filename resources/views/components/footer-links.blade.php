<ul class="not-prose whitespace-nowrap justify-center flex-wrap flex items-center  mt-2 mx-1 text-sm text-gray-500 dark:text-gray-300  sm:mr-4 sm:pr-4 list-none">
	...
	<li class="my-2 mx-1">
		<a href="{{ Hyde::relativeLink('community.html', $currentPage) }}" class="text-gray-500 dark:text-gray-300   dark:hover:text-gray-100   hover:text-gray-900 flex items-center mx-2">
			Resources
		</a>
	</li>
	<li class="my-2 mx-1">
	...
	<li class="my-2 mx-1">
		<a href="https://www.buymeacoffee.com/caen" class="text-gray-500 dark:text-gray-300   dark:hover:text-gray-100   hover:text-gray-900 flex items-center mx-2">
			Sponsor
		</a>
	</li>
</ul>