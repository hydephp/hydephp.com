...
<div class="flex flex-wrap justify-center max-w-7xl mx-auto my-4 lg:my-8 items-stretch">
	<div class="my-4 px-4 w-full md:w-1/2 xl:w-1/3 max-w-md h-auto">
		<div class="bg-white text-slate-900 p-4 pb-8 rounded-lg shadow-xl h-full relative">
			...
			<strong id="counter-framework-downloads-total" class="text-5xl font-extrabold text-transparent bg-clip-text bg-linear-to-br from-purple-500 to-red-600">
	...
	<div class="my-4 px-4 w-full md:w-1/2 xl:w-1/3 max-w-md h-auto">
		<div class="bg-white text-slate-900 p-4 pb-8 rounded-lg shadow-xl h-full relative">
			...
			<strong id="weekly-views-total" class="text-5xl font-extrabold text-transparent bg-clip-text bg-linear-to-br from-purple-500 to-red-600">
	...
	<div class="my-4 px-4 w-full md:w-1/2 xl:w-1/3 max-w-md h-auto">
		<div class="bg-white text-slate-900 p-4 pb-8 rounded-lg shadow-xl h-full relative">
			...
			<strong id="counter-lines-total" class="text-5xl font-extrabold text-transparent bg-clip-text bg-linear-to-br from-purple-500 to-red-600">
