...
>
    <div class="mx-auto flex h-16 max-w-[1160px] items-center gap-7 px-7">
        ...
        <a
            href="{{ $home ?? '/' }}"
            class="flex items-center gap-2.5 rounded-sm font-['Instrument_Serif',serif] text-xl font-semibold text-white no-underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8d7bf5]/70 focus-visible:ring-offset-4 focus-visible:ring-offset-[#14111c]"
        >
