...
<div x-data="{ show:true }" x-show="show"
    ...
    <div class="px-4 py-3">
        <div class="flex items-center gap-3">
            {{-- Contextual icon --}}
            @if($viewedLabel === 'old')
                <svg class="w-5 h-5 text-amber-700 dark:text-amber-300 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            ...
            @elseif($viewedLabel === 'upcoming')
                <svg class="w-5 h-5 text-indigo-700 dark:text-indigo-300 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            ...
            @else
                <svg class="w-5 h-5 text-gray-700 dark:text-gray-300 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
