...
<div class="relative items-center justify-center w-screen min-h-screen">
    <div class="pt-36 md:pt-64 container self-center my-auto flex flex-col items-center justify-center h-full max-w-6xl pl-0 mx-auto -mt-24 sm:pl-8 xl:pl-0 md:flex-row md:justify-between">
        ...
        <div id="countdown-parent" class="flex flex-col items-end justify-center w-5/6 h-auto pl-0 pr-0 mt-16 mb-12 sm:pl-20 sm:pr-8 xl:pr-0 md:mt-0 md:h-full sm:w-2/3 lg:-mt-4">
            <!-- HERO SVG IMAGE -->
...
{{--                    <path d="M198.56 112.66a10.09 10.09 0 017.11 2c3.58 2.6 4.3 6.79 3.62 10.34 0 0 4.78.6 7.87 2.9s5.45 5.12 10 15.82 6.54 17.17 7.92 23.12c1.38 5.95 1.84 11.08 1 15.59a18.37 18.37 0 01-2.48 6.86h-74.19l-.9-53.57s5.21-9.86 19.92-11.83a8.35 8.35 0 013.45-9.39c5.4-3.7 16.68-1.84 16.68-1.84z" fill="#c4b5fd" />--}}
...
{{--                    <path fill="#c4b5fd" d="M187.08 145.12l2.92 2.61-6.26 7.29-2.57.51-.81-2.39z" />--}}
...
{{--                    <path d="M159.52 40.14V21.63a8.27 8.27 0 018.25-8.25h60.22a8.27 8.27 0 018.25 8.25v33.52a8.28 8.28 0 01-8.25 8.25h-60.22a8.28 8.28 0 01-8.25-8.25V40.14z" fill="#c4b5fd" />--}}
...
{{--                    <circle fill="#c4b5fd" cx="108.43" cy="37.6" r="2.38" />--}}
...
{{--            </svg>--}}
            ...
            <script>
                const countDownDate = new Date("2023 03 14 12:00 GMT+1").getTime();
