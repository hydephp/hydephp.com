...
<header class="mx-auto max-w-[1000px] px-7 pt-[76px] text-center">
  ...
  <h1 class="mt-4 [font-family:'Playfair_Display',serif] opacity-90 text-[clamp(2.8rem,6.5vw,4.6rem)] font-[420] leading-none tracking-[-.015em]">
...
<div x-data="archive(@js([
  ...
  >
    <div class="reveal mx-auto max-w-[1000px] px-7 pt-12">
      <a class="group relative block overflow-hidden rounded-2xl border border-[rgba(164,156,186,.16)] bg-[#1c1827] p-[52px] no-underline transition duration-500 ease-out hover:-translate-y-1 hover:border-[#5e50b8] hover:shadow-[0_34px_70px_-38px_rgba(94,80,184,.7)] motion-reduce:transform-none motion-reduce:transition-none max-[860px]:px-7 max-[860px]:pb-11 max-[860px]:pt-9" style="background: radial-gradient(700px 340px at 85% -20%, rgba(141,123,245,.16), transparent 65%), radial-gradient(500px 300px at 0% 110%, rgba(214,162,74,.08), transparent 60%), #1c1827;" href="{{ $featured['route'] }}">
        ...
        <h2 class="mt-[18px] max-w-[20ch] [font-family:'Playfair_Display',serif] opacity-90 text-[clamp(1.8rem,3.8vw,2.7rem)] font-[440] leading-[1.1] tracking-[-.012em]">{{ $featured['title'] }}</h2>
        ...
        <div class="mt-7 flex flex-wrap items-center gap-3.5 text-[.85rem] text-[#a49cba]">
          <span class="flex h-[34px] w-[34px] flex-none items-center justify-center rounded-full [font-family:'Playfair_Display',serif] opacity-90 text-base font-medium italic text-white" style="background: radial-gradient(circle at 32% 28%, #8d7bf5, #5e50b8);" aria-hidden="true">{{ mb_substr($featured['author']?->name ?? 'H', 0, 1) }}</span>
  ...
  <main data-ledger class="mx-auto max-w-[1000px] scroll-mt-24 px-7 pb-10 pt-[72px]" id="archive" x-ref="ledger">
    ...
    @foreach ($ledgerByYear as $year => $entries)
      ...
      >
        <div class="reveal grid grid-cols-[170px_1fr] gap-10 pb-3 pt-11 max-[860px]:grid-cols-1 max-[860px]:gap-2 max-[860px]:pt-9">
          <div class="sticky top-24 self-start [font-family:'Playfair_Display',serif] opacity-90 text-[2.6rem] font-[380] italic leading-none text-[#252031] [-webkit-text-stroke:1px_rgba(164,156,186,.35)] max-[860px]:static max-[860px]:text-[2rem]">{{ $year }}</div>
          <div>
            @foreach ($entries as $entry)
              ...
              >
                ...
                <span class="transition-transform duration-300 ease-out group-hover:translate-x-1 motion-reduce:transform-none motion-reduce:transition-none">
                  <h3 class="[font-family:'Playfair_Display',serif] opacity-90 text-[1.28rem] font-[470] leading-[1.25] tracking-[-.005em] transition-colors group-hover:text-[#8d7bf5]">{{ $entry['title'] }}</h3>
    ...
    >
      <p class="[font-family:'Playfair_Display',serif] opacity-90 text-[1.7rem] font-[420] italic text-[#a49cba]">Nothing in the ledger for that.</p>
    ...
    <div class="reveal flex flex-wrap items-center justify-center gap-5 pt-12">
      <p class="text-center [font-family:'Playfair_Display',serif] opacity-90 text-[.88rem] italic text-[#a49cba]">No newsletter popup here. <a href="{{ $feed }}" class="not-italic text-[#d6a24a] no-underline hover:underline">Subscribe by RSS</a>, like nature intended.</p>
    </div>
  </main>
</div>
