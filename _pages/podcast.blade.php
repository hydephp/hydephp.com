...
@section('content')
    ...
    <main class="mx-auto max-w-7xl py-16 px-8">
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-8">
            ...
            <p class="mb-4">Explore the world of HydePHP in this unique, AI-generated podcast episode. Experience a blend of technology and creativity as we dive deep into the features and benefits of this innovative static site generator, as narrated by a dynamic duo in this podcast episode generated by <a href="https://notebooklm.google/" class="text-gray-700 hover:text-indigo-500" rel="noopener nofollow">NotebookML</a>, a cutting-edge research project by Google.</p>
        ...
        <div class="bg-gray-100 rounded-lg p-6">
            ...
            <p class="mb-2">This podcast episode was created using advanced AI technology from <a href="https://notebooklm.google/" class="text-gray-700 hover:text-indigo-500" rel="noopener nofollow">NotebookML</a>. Here's what makes it special:</p>
