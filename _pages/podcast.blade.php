...
@section('content')
    ...
    <main class="mx-auto max-w-7xl py-16 px-8">
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-8">
            ...
            <div id="transcript-container" class="mt-4 p-4 bg-gray-50 rounded h-[11rem] overflow-hidden">
                <h3 class="font-semibold mb-2">Transcript</h3>
                <div id="transcript" class="text-sm"></div>
            </div>

            <p class="text-sm text-gray-600 italic mt-4">Note: This podcast episode is entirely generated by AI, showcasing the potential of artificial intelligence in content creation.</p>
        </div>
