        ...
        <div class="py-12 px-8 bg-offset md:px-0">
            ...
            <article class="mx-auto max-w-7xl bg-white dark:bg-slate-700 rounded-lg p-6">
                ...
                <div class="prose dark:prose-invert max-w-full">
                    ...
                    <p>While this content is AI-generated, it reflects our commitment to exploring innovative ways to share information about HydePHP.</p>
                    <p>We hope you enjoy this blend of technology and creativity! Want to learn more about how this was created?
                        Head to our <a href="/posts/ai-podcast-episode">blog post on the topic</a> to learn more!
                    </p>
                </div>
            </article>
        </div>
